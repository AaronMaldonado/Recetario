...
class main(QtGui.QWidget):
    ...
    def cargar_categoria(self):
        ...
        self.model = QtGui.QStandardItemModel(10,1)
        self.model.setHorizontalHeaderItem(0, QtGui.QStandardItem(u"Recetas"))
        #self.model.setHorizontalHeaderItem(1, QtGui.QStandardItem(u"Cantidad"))


        self.ui.table_categoria.setModel(self.model)

        self.ui.table_categoria.setColumnWidth(0,200)
